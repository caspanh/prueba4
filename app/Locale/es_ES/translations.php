...
return array(
    ...
    'Add a screenshot' => 'Añadir imagen',
    'Take a screenshot and press CTRL+V or ⌘+V to paste here.' => 'Pulse CTRL+V o ⌘+V para pegar aquí.',
    ...
    // 'Database version:' => '',
    // 'Browser:' => '',
    'Example of search' => 'Ejemplo de busqueda',
    'Task view' => 'vista de Tareas',
    'Edit task' => 'Editar Tarea',
    'Edit description' => 'Editar descripción',
    'New internal link' => 'Nuevo enlace interno',
    'Display list of keyboard shortcuts' => 'Visualización de la lista de atajos de teclado',
    // 'Menu' => '',
    ...
    'Search in activity stream' => 'Buscar en el Tráfico de actividad',
    'My activities' => 'Mis actividades',
    'Activity until yesterday' => 'Actividad hasta ayer',
    'Activity until today' => 'Actividad hasta hoy',
    'Search by creator: ' => 'Buscar por el creador',
    'Search by creation date: ' => 'Búsqueda por fecha de creación: ',
    'Search by task status: ' => 'Búsqueda por estado de la tarea: ',
    'Search by task title: ' => 'Búsqueda por título de la tarea: ',
    'Activity stream search' => 'Tráfico de actividad de búsqueda',
    'Projects where "%s" is manager' => 'Proyectos donde "%s" es gerente',
    'Projects where "%s" is member' => 'Proyectos donde "%s" es miembro de',
    'Open tasks assigned to "%s"' => 'tareas abiertas que tenga asignadas "%s"',
    'Closed tasks assigned to "%s"' => 'tareas asignadas cerrados a "%s"',
