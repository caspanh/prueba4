...
<div class="dropdown">
    ...
    <ul>
        ...
        <li><a href="#" class="filter-helper" data-filter="estatus:abierta assignado:yo"><?= t('My tasks') ?></a></li>
        ...
        <li><a href="#" class="filter-helper" data-filter="estatus:abierta"><?= t('Open tasks') ?></a></li>
